/*
  Sidebar.jsx
  Extracted from SalesHistory.jsx sidebar implementation
*/
import React from "react";
import "./SalesHistory.css"; // Reusing the CSS for now, will refactor later if needed
    ...
    return (
        <aside className="sidebar">
            <div className="sidebar-header">
                ...
                <div>
                    <span className="brand-name">BillMaster</span><br />
            ...
            <div className="sidebar-footer">
                <div className="user-profile">
                    ...
                    <div>
                        <div className="user-name">Mike Admin</div>
